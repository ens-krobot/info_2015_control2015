...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa50b6ec0385a7ae7dbaca243d0ca1df) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/krobot_cachan/krobot";
          synopsis = "[Kro]bot";
          description =
            Some
              [OASISText.Para "Control program for the Eurobot robotic cup."];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Adjust_map"; "Ransac"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "krobot";
                      lib_findlib_name = Some "urg-location";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "krobot_simulator.ml"
                   });
               Executable
                 ({
                     cs_name = "krobot-mover";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "mover.ml"});
               Executable
                 ({
                     cs_name = "krobot-urg-location";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/tools/urg_location/";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "krobot";
                           InternalLibrary "krobot-urg-location";
                           FindlibPackage ("lwt.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "control.ml"});
               Executable
                 ({
                     cs_name = "krobot-game";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "game_strat.ml"});
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/tools/fake_beacons/";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "krobot";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "arduino.ml"});
               Executable
                 ({
                     cs_name = "krobot-xbee";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "xbee.ml"});
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dump_ax12.ml"});
               Executable
                 ({
                     cs_name = "krobot-urg-filter-generator";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "urg_filter_generator.ml"
                   });
               Executable
                 ({
                     cs_name = "krobot-urg-calibrate";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "urg_calibrate.ml"});
               Executable
                 ({
                     cs_name = "krobot-text";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://git@bitbucket.org:krobot_cachan/krobot.git";
                      src_repo_browser =
                        Some "https://bitbucket.org/krobot_cachan/krobot";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\b\235N|\207lw\169\145KB\007\151\187`V";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
